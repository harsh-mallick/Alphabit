...
const Page = () => {
    return (
        <div className='bg-[#0a0a0a] text-[#f3f4f6] font-sans min-h-screen pt-10 pb-8 px-8'>
            <div class="max-w-4xl mx-auto">
                <h1 class="text-4xl md:text-5xl font-extrabold text-center mb-12 bg-clip-text text-transparent bg-gradient-to-r from-[#7c3aed] to-[#3b82f6]">
                ...
                <div class="relative">
                    ...
                    <div class="flex flex-col md:flex-row md:justify-end w-full mb-16 left-event">
                        ...
                        <div class="flex justify-center md:block md:w-2/12 relative">
                            <div class="absolute inset-y-0 flex items-center md:left-1/2 md:transform md:-translate-x-1/2">
                                <div class="w-10 h-10 bg-[#3b82f6] rounded-full flex items-center justify-center border-4 border-[#0a0a0a] shadow-lg z-20">
                    ...
                    <div class="flex flex-col md:flex-row md:justify-start w-full mb-16 right-event">
                        ...
                        <div class="flex justify-center md:block md:w-2/12 relative">
                            <div class="absolute inset-y-0 flex items-center md:left-1/2 md:transform md:-translate-x-1/2">
                                <div class="w-10 h-10 bg-[#7c3aed] rounded-full flex items-center justify-center border-4 border-[#0a0a0a] shadow-lg z-20">
                    ...
                    <div class="flex flex-col md:flex-row md:justify-end w-full left-event">
                        ...
                        <div class="flex justify-center md:block md:w-2/12 relative">
                            <div class="absolute inset-y-0 flex items-center md:left-1/2 md:transform md:-translate-x-1/2">
                                <div class="w-12 h-12 bg-gradient-to-r from-[#7c3aed] to-[#3b82f6] rounded-full flex items-center justify-center border-4 border-[#0a0a0a] shadow-2xl shadow-[#3b82f6]/50 z-20">
