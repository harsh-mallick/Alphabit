                    ...
                    return (
                        <div className="card w-[25rem] h-auto border-2 border-gray-800 rounded-2xl bg-gray-800/30 mt-3" key={event.heading}>
                            ...
                            <div className='text-center p-3'>
                                <button className='to-75% via-20% from-blue-700 via-blue-600 to-purple-800 bg-gradient-to-r text-lg font-bold mt-4 rounded-md w-full h-12 cursor-pointer hover:from-blue-900 hover:via-blue-800 hover:to-purple-900'>Register</button>
                            </div>
                        </div>
                    )
                })}
